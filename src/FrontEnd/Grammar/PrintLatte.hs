...
instance Print TopDef where
  prt i e = case e of
    ...
    ClassExtDef id1 id2 clsstmts -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 clsstmts, doc (showString "}")])
    ClassDef id clsstmts -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 clsstmts, doc (showString "}")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print ClsStmt where
  prt i e = case e of
